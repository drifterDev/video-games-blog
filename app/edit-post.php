...
<body class="bg-[url('../img/cubes.png')]">
  ...
  <div id="container" class="flex flex-wrap">
    ...
    <main id="main" class="w-full m-5 lg:my-8 lg:ml-8 lg:w-[66%] md:w-[62%] p-5 md:p-8 bg-white">
      ...
      <form action="save/post.php?val=edit&id=<?= $post["id"] ?>" method="POST">
        ...
        <div class="w-full flex flex-col">
          ...
          <textarea name="description" id="description" cols="20" rows="5" class=" px-2 py-1 inline w-64 mb-2 md:mb-5 border-2 border-gray-600 rounded"><?= $post["descripcion"] ?></textarea>
        </div>
        <div class="w-full flex flex-col">
          <div class="w-64">
